...
public class TestProductOperation {
		...
		public static void main(String[] args) {
			...
			productList.add(new Products(5, "Watch",
					...
					84000, 100));
			productList
					.add(new Products(6, "Guitar", "Yamaha F280 Acoustic Rosewood Guitar (Natural, Beige)", 8000, 100));
			...
			List<Products> allProducts = operation.getAllProducts();
			for (Products products : allProducts) {
				System.out.println(products);
			}
			Products updated = new Products();
			updated.setName("Leena");
			updated.setDescription("New Description");
			updated.setPrice(99.99);
			updated.setQuantity(50);
			updated.setId(1);

			operation.updateProduct(updated);

			operation.deleteProduct(110);
		}
